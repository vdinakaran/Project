...
public class BookingController {
	...
	public ResponseEntity<TicketBooking> addTicketBooking(@RequestBody TicketBooking t,
	 ...
	 */
	@GetMapping("/findall")
	public ResponseEntity<List<TicketBooking>> viewAllBookings() throws AccessForbiddenException, BookingNotFoundException {
		/*
		 * if (!loginController.loginStatus()) throw new
	...
	public TicketBooking updateTicketBooking(@RequestBody TicketBooking t)
	...
	public TicketBooking deleteTicketBookingById(@PathVariable int bookingId)
			throws BookingNotFoundException, AccessForbiddenException {
		/*
		 * if (!loginController.loginStatus()) throw new
		 * AccessForbiddenException("Not Logged In/Invalid Loggin");
	...
	public ResponseEntity<TicketBooking> viewBooking(@PathVariable int bookingId)
			throws BookingNotFoundException {
		ResponseEntity<TicketBooking> response = null;
		try {
			TicketBooking booking = bookingService.viewBooking(bookingId);
	...
	public ResponseEntity<List<TicketBooking>> viewMovieByMovieId(@PathVariable int movieId)
			throws AccessForbiddenException, BookingNotFoundException {
		/*
		 * if (!loginController.loginStatus()) throw new
		 * AccessForbiddenException("Not Logged In/Invalid Loggin");
	...
	public ResponseEntity<List<TicketBooking>> viewMovieByLocalDate(
