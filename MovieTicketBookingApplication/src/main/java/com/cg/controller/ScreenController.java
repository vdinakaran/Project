...
public class ScreenController {
	...
	public ResponseEntity<Theater>  getTheatreById(@PathVariable int screenId) throws ScreenNotFoundException {
		ResponseEntity<Theater> response = null;
		try {
			Theater theatre = screenService.getTheatre(screenId);
